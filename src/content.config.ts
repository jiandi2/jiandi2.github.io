...
const episodes=defineCollection({loader:glob({pattern:'**/*.md',base:'./src/data/episodes'}),schema:z.object({guest:z.string(),guestEn:z.string(),affiliation:z.string(),episodeNumber:z.number(),season:z.number(),sealTitle:z.string(),sealColor:z.string(),sealTint:z.string(),title:z.string(),summary:z.string(),fields:z.array(z.string()),portrait:z.string().optional(),portraitPosition:z.string().optional(),portraitScale:z.number().optional(),highlights:z.array(z.string()).optional(),sourceUrl:z.url().optional()})});
